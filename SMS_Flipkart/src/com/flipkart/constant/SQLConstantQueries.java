...
public class SQLConstantQueries {
	...
	public static final String CHANGE_SCHEDULE_BY_STUDENT = "update courseschedule set courseschedule=? where username=?,courseid=?";
	...
	public static final String UPDATE_PROFESSOR = "update professor set name=?,address=?,year=?,mobilenumber=? where username=?";
	...
	public static final String UPDATE_ADMIN = "update admin set name=?,address=?,year=?,mobilenumber=? where username=?";
	...
	public static final String LIST_STUDENTS = "select username from registration where course1id=? or course2id=? or course3id=? or course4id=?";
